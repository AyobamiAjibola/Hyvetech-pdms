...
exports.$createEstimateSchema = {
    ...
    tax: joi_1.default.any().optional().label(exports.estimateFields.tax.label),
    taxPart: joi_1.default.any().optional().label(exports.estimateFields.taxPart.label),
...
exports.$saveEstimateSchema = {
    ...
    tax: joi_1.default.any().allow('').optional().label(exports.estimateFields.tax.label),
    taxPart: joi_1.default.any().optional().label(exports.estimateFields.taxPart.label),
