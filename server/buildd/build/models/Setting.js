...
exports.$updateSetting = {
    name: joi_1.default.string().required().label('Settings Name'),
    type: joi_1.default.any().allow().label('Settings Type'),
    value: joi_1.default.string().required().label('Settings Value'),
};
