...
export const getAppointmentsHandler = authenticateRouteWrapper(
  async (req, res) => {
...
export const getAppointmentHandler = authenticateRouteWrapper(
  async (req, res) => {
...
export const rescheduleAppointmentHandler = authenticateRouteWrapper(
  async (req, res) => {
...
export const cancelAppointmentHandler = authenticateRouteWrapper(
  async (req, res) => {
