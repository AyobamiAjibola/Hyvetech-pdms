const main_welcome_individual_email = (fullName: string) => `
<!DOCTYPE html>
<html lang='en'>
                        ...
                        <tr>
                            <td class='contentBox'>
                                ...
                                <p class='text'>We believe in creating amazing experiences for vehicle owners and fleets
                                    ...
                                    technology. AutoHyve was created to help individuals, like you, and businesses be in
                                    control of your greatest assets by
                                    organizing and centralizing vehicle maintenance and repair activities in one place.
                                    If we can help you do this, then we
                                    can unlock amazing experiences for you - like, cost savings, self-service analytics,
                                    AI-powered recommendations, and
                                    more.</p>

                                <p class='text'>Today, we are happy to be sharing this technology used by businesses and
                                    500 other
                                    vehicle owners with you. The product
                                    is still in its BETA phase.</p>

                                <p class='text'>To get started with your account, please log into your Hyve, and you
                                    will be ready to
                                    receive estimates from AutoHyve
                                    powered workshops, and get real-time analytics.</p>

                                <p class='text'>If your favorite workshop is not on AutoHyve, tell us their name on the
                                    “Workshops”
                                    tab in your app, and we will
...
export default main_welcome_individual_email;
