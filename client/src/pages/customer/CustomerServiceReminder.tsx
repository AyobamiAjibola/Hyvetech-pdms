...
function CustomerServiceReminder() {
    ...
    useEffect(() => {
      ...
      const temp = _temp01.filter(reminder => {
        return reminder.customerId == customerId && reminder.partnerId === admin.user?.partner?.id;
      });
...
export default CustomerServiceReminder;