  ...
  const handleShareLink = async () => {
    ...
    const message =
      `${estimate?.partner.name} has sent you an estimate.\nAmount Due: NGN${
        estimate?.grandTotal && formatNumberToIntl(estimate?.grandTotal)
      }\n\n` + fileUrl;
  ...
  if (!estimate)
    ...
    return (
      <React.Fragment>
        ...
        <Box
          component="div"
          sx={{ display: 'flex', justifyContent: { sm: 'space-between', xs: 'space-between' }, alignItems: 'center' }}>
        ...
        <AppModal
          ...
          ActionComponent={
            <DialogActions>
              <Button
                onClick={() => {
                  generateInvoice(), setCount(false);
                }}>
                Yes
              </Button>
