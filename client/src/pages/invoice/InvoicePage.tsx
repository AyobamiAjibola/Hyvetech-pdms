...
import { Alert, Avatar, Box, Button, Collapse, Divider, FormControl, Grid, Input, InputLabel, MenuItem, Paper, Select, Stack, TextField, Typography } from '@mui/material';
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <Grid item xs={4} sm={3}
            sx={{
              fontWeight: 600, textAlign: {md: 'center', lg: 'left', sm: 'center'},
              fontSize: {xs: '13px', sm: '16px'}, display: {xs: 'none', sm: 'block'}
            }}
          >
            Warranty
          </Grid>
            ...
            : labours.map((labour, idx1) => {
                return (
                  <Grid
                    ...
                    <Grid item xs={5} sm={3} sx={{textAlign: {xs:'left'}, fontSize: {xs: '13px', sm: '16px'}}}>
                      {formatNumberToIntl(+labour.cost)} x 1
                    </Grid>
                    <Grid item xs={4} sx={{textAlign: {xs:'right'}, fontSize: {xs: '13px', sm: '16px'}}}>
