...
function InvoicesPage() {
  ...
  const transactionReducer = useAppSelector(
    ...
    return [
      ...
      // },
      {
        ...
        valueGetter: (param) => {
          ...
          return vehicle
            ? `${vehicle?.modelYear} ${vehicle?.make} ${vehicle?.model} (${vehicle?.plateNumber})`
            : "";
        },
      },
      {
      ...
      },
      {
        ...
        valueFormatter: ({ value }) => {
          return value
            ? Math.sign(value) === -1
              ? 0
              : formatNumberToIntl(value.toFixed(2))
            : 0;
        },
      },
      {
      ...
      },
      {
        ...
        renderCell: (params) => {
          ...
          ? (
            ...
            params.row.depositAmount == 0 ? (
            <Chip
              label={params.row.depositAmount != 0 ? "" : "Not Paid"}
              size="small"
              color="error"
            />
        ...
        getActions: (params: any) => [
          <GridActionsCellItem
            ...
            icon={
              <Edit
                sx={{
                  display: isTechAdmin ? "block" : "none",
                  color: "limegreen",
                }}
              />
            }
    ...
    <React.Fragment>
      ...
      {closeEstimateModal && (
        <AppModal
          ...
          Content={
            <DialogContentText>{MESSAGES.closeEstimateModal}</DialogContentText>
          }
          ActionComponent={
            <DialogActions>
              <Button
      ...
      <AppLoader
        show={transactionReducer.initRefundCustomerStatus === "loading"}
      />
      <AppLoader
        show={transactionReducer.verifyRefundCustomerStatus === "loading"}
      />
      <AppModal
        fullWidth
        ...
        ActionComponent={
          <DialogActions>
            <Button onClick={() => invoice.setShowDelete(false)}>
              Disagree
            </Button>
      ...
      <AppModal
        ...
        show={invDel}
        Content={
          <DialogContentText>{MESSAGES.deleteInvoice}</DialogContentText>
        }
        ActionComponent={
          <DialogActions>
