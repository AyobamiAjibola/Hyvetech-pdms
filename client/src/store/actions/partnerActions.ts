...
export const createPartnerAction = createAsyncThunk<any,
    ICreatePartnerModel,
...
export const getPartnersAction = createAsyncThunk<any,
    void,
    { rejectValue: { message: string } }>(
    GET_PARTNERS,
...
export const getPartnerAction = createAsyncThunk<any,
    number,
    { rejectValue: { message: string } }>(
    GET_PARTNER,
